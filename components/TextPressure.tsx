...
const TextPressure: React.FC<TextPressureProps> = ({
    ...
    const setSize = useCallback(() => {
        ...
        // Adjusting font size calculation to be more predictable
        ...
        setScaleY(1);
        setLineHeight(1.1); // Better vertical centering
        ...
        const animate = () => {
            ...
            if (titleRef.current) {
                ...
                spansRef.current.forEach(span => {
                    ...
                    // Tighter ranges to prevent extreme thinness or massive clipping
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full overflow-visible bg-transparent flex items-center justify-center">
            ...
            <h1
                ref={titleRef}
                className={`text-pressure-title ${className} ${flex ? 'flex items-center justify-center gap-[0.2em]' : ''
